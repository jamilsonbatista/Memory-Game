...
// Mail settings
Config::write('Mailer.transport', "piano@piano.com.br"); // smtp 
Config::write('Mailer.smtp.host', "mail.domain.com"); //mail.domain.com
Config::write('Mailer.smtp.port', '25');
Config::write('Mailer.smtp.encryption', '');
Config::write('Mailer.smtp.username', 'paino'); //email
Config::write('Mailer.smtp.password', '123'); //password